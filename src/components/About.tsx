    ...
    <section className="section about">
      <div className="description card">
        ...
        <p>
          ...
          or maybe <span className="text-gradiant italic">Mo</span>re <span className="text-gradiant italic">Calc</span>ulators...
        </p>
        <p>Regardless of the name, <span className="text-gradiant">MoCalc</span> can help you compare different Mortgage scenarios quickly.</p>
      </div>
    </section>
  )
}